System.register(['angular2/core', 'angular2/router', './consultant-filter.pipe', './consultant.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ConsultantListComponent = (function () {
                function ConsultantListComponent(_consultantService) {
                    this._consultantService = _consultantService;
                    this.pageTitle = 'Consultant List';
                    this.imageWidth = 50;
                    this.imageMargin = 2;
                    this.showImage = false;
                }
                ConsultantListComponent.prototype.toggleImage = function () {
                ...
                ConsultantListComponent = __decorate([
                    core_1.Component({
            ...
            exports_1("ConsultantListComponent", ConsultantListComponent);
        }
    }
});
//# sourceMappingURL=consultant-list.component.js.map